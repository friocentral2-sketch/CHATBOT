...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let state = {
        currentNode: "INICIO", // Nodos: INICIO, WIFI_APOYO, PASSWORD_RECUPERACION, AVERIA_AULAS, TICKET_CREACION, RESUELTO
        userName: "Josué Robles",
        userId: "0105847293", // Cédula/ID Estudiante simulado
    ...
    function getBotResponse(text) {
        ...
        switch (state.currentNode) {
            ...
            case "RESUELTO":
                if (inputLower.includes("sí") || inputLower.includes("si") || inputLower.includes("gracias") || inputLower.includes("resuelto")) {
                    resetState();
                    return "¡Qué excelente noticia! Me alegra haber sido útil. Que tengas un excelente día de clases en la Católica de Cuenca. 🎓💙";
                } else {
                    resetState();
                    return "Entendido. Si tienes algún otro problema, no dudes en volver a escribirme. Estoy aquí para servirte.";
                }
